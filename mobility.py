...
class MainWindow(QMainWindow):
    def __init__(self, window_width=1920, window_height=1080):
        ...
        # CSV 및 XML 파일 로드
        self.load_csv_files()
        self.xml_data = self.parse_xml_to_json(os.path.abspath("data/network.xml"))
    ...
    def load_csv_files(self):
        try:
            csv_file_path1 = os.path.abspath("data/Deajeon_V6_Output1_data_with_updated_SSM_indicators.csv")
            ...
            csv_file_path3 = os.path.abspath("data/Deajeon_V6_Output1_data_Macro.csv")
